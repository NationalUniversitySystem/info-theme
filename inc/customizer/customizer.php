...
function nusa_customize_preview_js() {
	wp_enqueue_script( 'nusa-customizer', get_template_directory_uri() . '/assets/js/wp-customizer.min.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_controls_enqueue_scripts', 'nusa_customize_preview_js' );
